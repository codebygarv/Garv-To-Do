...
const TaskItem: React.FC<{ isListInView1: boolean; task: Task }> = ({
  ...
  return (
    <>
      <li key={task.id}>
        <article
            style={{ backgroundColor: '#3E4684', color:'white'}}  className={`bg-slate-100 rounded-lg p-3 sm:p-4 flex text-left transition hover:shadow-lg hover:shadow-slate-300 dark:bg-slate-800 dark:hover:shadow-transparent  ${
